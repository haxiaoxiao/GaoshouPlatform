...
chcp 65001 >nul
title GaoshouPlatform AI Native Shutdown
...
echo ========================================
echo   GaoshouPlatform AI Native Shutdown
echo ========================================
echo Root:      %ROOT%
...
echo [1/3] Stopping AI Native backend/sync/frontend processes on configured ports...
...
echo.
echo ========================================
echo   AI Native shutdown complete
echo ========================================
echo.
if "%NO_PAUSE%"=="0" pause
exit /b 0
