...
echo [1/7] Stopping stale project backend/sync/frontend processes...
...
if errorlevel 1 (
  ...
  echo   Startup failed
  echo ========================================
  echo Check the sync service window for details.
  echo.
  if "%NO_PAUSE%"=="0" pause
  exit /b 1
)
...
if errorlevel 1 (
  ...
  echo   Startup failed
  echo ========================================
  echo Check the frontend window for details.
  echo.
  if "%NO_PAUSE%"=="0" pause
  exit /b 1
)
