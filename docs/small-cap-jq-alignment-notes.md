...
本文记录截至 2026-05-25，为了让本地 AKQuant 版本的小市值 V4 策略对齐聚宽源码与日志，已经确认并落地的参数、数据和行为口径调整。

当前定位：这是一份阶段对齐记录，主要服务 ID=43 小市值策略排查。日常使用请先看 `docs/user-manual.md`；因子缓存和预计算口径请看 `docs/factor-value-store.md`。
...
- 当前完整分钟线覆盖 `2005-01-04 09:31:00` 至 `2026-05-15 15:00:00`。
