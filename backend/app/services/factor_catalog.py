...
RELAY_FACTOR_SPECS: dict[str, dict[str, Any]] = {
    ...
    "jq_moneyflow_net_amount_main": {
        "label": "JQ Main Moneyflow Net Amount",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_amount_main", "jq_money_flow_daily.trade_date_1"],
        "description": "Main-order net inflow amount from JoinQuant daily stock money-flow data.",
        "formula": "jq_money_flow_daily.net_amount_main, dated by trade_date_1",
        "human_description": "聚宽个股资金流主力净流入金额。jq_money_flow_daily.trade_date 为空，计算和筛选统一使用 trade_date_1。",
    },
    "jq_moneyflow_net_pct_main": {
        "label": "JQ Main Moneyflow Net Percent",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_pct_main", "jq_money_flow_daily.trade_date_1"],
        "description": "Main-order net inflow percent from JoinQuant daily stock money-flow data.",
        "formula": "jq_money_flow_daily.net_pct_main, dated by trade_date_1",
        "human_description": "聚宽个股资金流主力净流入占比。适合做横截面排序或与成交额、市值做标准化组合。",
    },
    "jq_moneyflow_net_amount_xl": {
        "label": "JQ Extra-large Moneyflow Net Amount",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_amount_xl", "jq_money_flow_daily.trade_date_1"],
        "description": "Extra-large-order net inflow amount from JoinQuant daily stock money-flow data.",
        "formula": "jq_money_flow_daily.net_amount_xl, dated by trade_date_1",
        "human_description": "聚宽超大单净流入金额。它更偏大资金交易行为，需结合流动性和换手过滤。",
    },
    "jq_moneyflow_net_pct_xl": {
        "label": "JQ Extra-large Moneyflow Net Percent",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_pct_xl", "jq_money_flow_daily.trade_date_1"],
        "description": "Extra-large-order net inflow percent from JoinQuant daily stock money-flow data.",
        "formula": "jq_money_flow_daily.net_pct_xl, dated by trade_date_1",
        "human_description": "聚宽超大单净流入占比。适合刻画大单资金强弱，但需要验证行业和市值暴露。",
    },
    "jq_moneyflow_net_amount_l": {
        "label": "JQ Large Moneyflow Net Amount",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_amount_l", "jq_money_flow_daily.trade_date_1"],
        "description": "Large-order net inflow amount from JoinQuant daily stock money-flow data.",
        "formula": "jq_money_flow_daily.net_amount_l, dated by trade_date_1",
        "human_description": "聚宽大单净流入金额，可与超大单和主力净流入一起评估资金结构。",
    },
    "jq_moneyflow_net_pct_l": {
        "label": "JQ Large Moneyflow Net Percent",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_pct_l", "jq_money_flow_daily.trade_date_1"],
        "description": "Large-order net inflow percent from JoinQuant daily stock money-flow data.",
        "formula": "jq_money_flow_daily.net_pct_l, dated by trade_date_1",
        "human_description": "聚宽大单净流入占比，可用于资金结构类候选因子。",
    },
    "jq_moneyflow_net_mf_amount": {
        "label": "JQ Net Moneyflow Amount",
        "category": "jq_moneyflow",
        "dependencies": ["jq_money_flow_daily.net_mf_amount", "jq_money_flow_daily.trade_date_1"],
        "description": "Tushare-compatible net moneyflow amount field in JoinQuant money-flow dataset when available.",
        "formula": "jq_money_flow_daily.net_mf_amount, dated by trade_date_1",
        "human_description": "迁移表中兼容 Tushare 口径的净流入金额字段。覆盖和口径可能与 JQ 主力字段不同，使用前需看覆盖率。",
    },
...
CN_PAPER_FACTOR_SPECS: dict[str, dict[str, Any]] = {
    ...
    "asset_backed_value_proxy_pit": {
        "label": "Asset-Backed Value PIT",
        "category": "independent_fundamental_pit",
        "dependencies": [
            "stock_daily_basic.pb",
            "financial_data.roe",
            "financial_data.total_assets",
        ...
        "description": "Point-in-time balance-sheet asset support value proxy from the 2026-06-18 independent factor audit.",
        "lookback": 370,
        "formula": "mean(rank_low_pb, rank_equity_to_assets, rank_low_debt, rank_roe)",
        "human_description": "Deep-value proxy that combines low PB with balance-sheet support and profitability using PIT financial alignment.",
        "paper_ids": [19, 22, 24, 27],
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "balance_sheet_quality_value_pit": {
        "label": "Balance-Sheet Quality Value PIT",
        "category": "independent_fundamental_pit",
        "dependencies": [
            "stock_daily_basic.pb",
        ...
        "description": "Point-in-time quality-value proxy combining low PB, equity support, low leverage and net margin.",
        "lookback": 370,
        "formula": "mean(rank_low_pb, rank_equity_to_assets, rank_low_debt, rank_net_margin)",
        "human_description": "Quality-value variant that tries to avoid cheap balance-sheet traps by adding capital structure and margin quality.",
        "paper_ids": [19, 22, 24, 27],
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "growth_duration_proxy_pit": {
        "label": "Growth Duration PIT",
        "category": "independent_fundamental_pit",
        "dependencies": [
            "stock_daily_basic.pb",
            "financial_data.revenue",
        ...
        "description": "Point-in-time growth-duration proxy from revenue growth, profit growth and high PB rank.",
        "lookback": 370,
        "formula": "mean(rank_revenue_yoy, rank_profit_yoy, rank_high_pb)",
        "human_description": "Short-history PIT experiment that treats persistent growth and market duration pricing as a growth sleeve candidate.",
        "paper_ids": [19, 21, 31, 44],
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "garp_duration_proxy_pit": {
        "label": "GARP Duration PIT",
        "category": "independent_fundamental_pit",
        "dependencies": [
            "stock_daily_basic.pb",
            "financial_data.revenue",
        ...
        "description": "Point-in-time GARP proxy: growth rank minus high PB rank.",
        "lookback": 370,
        "formula": "mean(rank_revenue_yoy, rank_profit_yoy, rank_roe) - rank_high_pb",
        "human_description": "Growth-at-a-reasonable-price variant that rewards growth quality only when valuation pressure is not excessive.",
        "paper_ids": [19, 21, 22, 31, 44],
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    ...
    "semibeta_downside_avoid_252": {
        ...
        "dependencies": ["klines_daily.close"],
        "description": "Negative downside semi-beta versus the selected-universe mean return over 252 trading days.",
        "lookback": 300,
        "formula": "-rolling_beta(stock_return, market_return | market_return < 0, 252)",
        "human_description": "Down-market beta avoidance signal. It separates downside participation from ordinary low-beta exposure.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "semibeta_upside_capture_252": {
        "label": "Semi-Beta Upside Capture 252D",
        "category": "independent_daily_risk",
        "dependencies": ["klines_daily.close"],
        "description": "Upside semi-beta versus the selected-universe mean return over 252 trading days.",
        "lookback": 300,
        "formula": "rolling_beta(stock_return, market_return | market_return > 0, 252)",
        "human_description": "Risk-on capture signal that measures how strongly a stock participates when the market cross-section is positive.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "semibeta_asymmetry_252": {
        "label": "Semi-Beta Asymmetry 252D",
        "category": "independent_daily_risk",
        "dependencies": ["klines_daily.close"],
        "description": "Upside semi-beta minus downside semi-beta over 252 trading days.",
        "lookback": 300,
        "formula": "semibeta_upside_capture_252 - downside_beta_252",
        "human_description": "Asymmetric participation factor: prefer stocks with more upside capture than downside participation.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "low_beta_252": {
        ...
        "category": "independent_daily_risk",
        "dependencies": ["klines_daily.close"],
        "description": "Negative 252-day beta versus the selected-universe mean return.",
        "lookback": 300,
        "formula": "-rolling_beta(stock_return, market_return, 252)",
        "human_description": "Classic low-beta proxy implemented with the current universe as the market leg.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "low_idio_vol_60": {
        "label": "Low Idiosyncratic Volatility 60D",
        "category": "independent_daily_risk",
        "dependencies": ["klines_daily.close"],
        "description": "Negative 60-day volatility of residual return after 252-day beta adjustment.",
        "lookback": 300,
        "formula": "-std(stock_return - beta_252 * market_return, 60)",
        "human_description": "Low residual-volatility sleeve that removes broad market beta before measuring volatility.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "low_downside_vol_60": {
        "label": "Low Downside Volatility 60D",
        "category": "independent_daily_risk",
        "dependencies": ["klines_daily.close"],
        "description": "Negative square-root mean downside-return variance over 60 trading days.",
        "lookback": 90,
        "formula": "-sqrt(mean(return^2 where return < 0, 60))",
        "human_description": "Downside-only volatility avoidance signal.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "low_max_return_20": {
        "label": "Low Max Return 20D",
        "category": "independent_price_volume",
        "dependencies": ["klines_daily.close"],
        "description": "Negative maximum one-day return over the last 20 trading days.",
        "lookback": 40,
        "formula": "-rolling_max(return_1d, 20)",
        "human_description": "Lottery-spike avoidance signal that penalizes recent extreme single-day jumps.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "return_autocorr_20": {
        "label": "Return Autocorrelation 20D",
        "category": "independent_price_volume",
        "dependencies": ["klines_daily.close"],
        "description": "20-day rolling autocorrelation between daily return and lagged daily return.",
        "lookback": 50,
        "formula": "corr(return_1d, lag(return_1d, 1), 20)",
        "human_description": "Short-horizon path-dependence proxy from return autocorrelation.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "momentum_120_skip20": {
        "label": "Momentum 120 Skip 20",
        "category": "independent_price_volume",
        "dependencies": ["klines_daily.close"],
        "description": "120-day momentum excluding the most recent 20 trading days.",
        "lookback": 150,
        "formula": "pct_change(close, 120) - pct_change(close, 20)",
        "human_description": "Intermediate momentum with recent month skipped to reduce short-term reversal contamination.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "jump_intraday_tail_20d": {
        "label": "Jump Intraday Tail 20D",
        "category": "independent_price_volume",
        "dependencies": ["klines_daily.high", "klines_daily.low"],
        "description": "Negative 20-day mean of large intraday high-low range tails.",
        "lookback": 40,
        "formula": "-mean((high / low - 1) where range > 6%, 20)",
        "human_description": "Intraday jump-tail risk proxy using daily high-low range.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
    "elasticity_amount_resilience_20d": {
        "label": "Amount Resilience 20D",
        "category": "independent_liquidity",
        "dependencies": ["klines_daily.close", "klines_daily.amount"],
        "description": "20-day average amount divided by 20-day return volatility.",
        "lookback": 50,
        "formula": "mean(amount, 20) / std(return_1d, 20)",
        "human_description": "Liquidity-resilience proxy: high traded amount with low price volatility scores better.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "amihud_low_impact_20": {
        "label": "Amihud Low Impact 20D",
        "category": "independent_liquidity",
        "dependencies": ["klines_daily.close", "klines_daily.amount"],
        "description": "Negative 20-day Amihud illiquidity proxy abs(return) / amount.",
        "lookback": 50,
        "formula": "-mean(abs(return_1d) / amount, 20)",
        "human_description": "Low-price-impact liquidity proxy.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "overnight_momentum_20": {
        "label": "Overnight Momentum 20D",
        "category": "independent_price_volume",
        "dependencies": ["klines_daily.open", "klines_daily.close"],
        "description": "20-day mean overnight return from previous close to current open.",
        "lookback": 50,
        "formula": "mean(open_t / close_t-1 - 1, 20)",
        "human_description": "Overnight drift signal using daily open and previous close.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "limit_ecology_quality_combo": {
        "label": "Limit Ecology Quality Combo",
        "category": "independent_limit_ecology",
        "dependencies": ["klines_daily.close", "klines_daily.high", "klines_daily.low", "stock_limit_prices"],
        "description": "Composite rank of limit-up sealing quality, follow-through, win-rate and limit-down avoidance.",
        "lookback": 50,
        "formula": "mean(rank(sealed_quality), rank(followthrough), rank(winrate), rank(-open_board_pressure), rank(-limit_down), rank(close_location))",
        "human_description": "Daily limit-up ecology factor built from local stock_limit_prices and OHLCV.",
        "frequency": "monthly",
        "data_policy": {"selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    ...
    "trend_support": {
        ...
        "category": "paper_minute",
        "dependencies": ["klines_minute.open", "klines_minute.close", "klines_minute.volume"],
        "description": "Original mining-report id alias for paper_trend_fund_support.",
        "lookback": 10,
        "formula": "sum(uptrend_minute_volume - downtrend_minute_volume) / sum(trend_minute_volume)",
        "human_description": "Compatibility alias for the minute trend-fund net support factor used in the independent-30 audit.",
        "paper_ids": [10, 11, 12],
        "frequency": "weekly",
        "data_policy": {"alias_of": "paper_trend_fund_support", "selection_direction": "high", "evidence": "independent_factor_mining_20260618"},
    },
    "intraday_shape_composite": {
        "label": "Intraday Shape Composite",
        "category": "paper_minute",
        "dependencies": ["klines_minute.close"],
        "description": "20-day cross-sectional rank blend of intraday log-price slope and convexity.",
        "lookback": 30,
        "formula": "mean(rank(mean(intraday_slope, 20)), rank(mean(intraday_convexity, 20)))",
        "human_description": "Minute path-shape factor from the independent-30 audit. It fits a simple intraday log-price slope and convexity per day, then ranks the 20-day means.",
        "paper_ids": [42],
        "frequency": "monthly",
        "data_policy": {"selection_direction": "low", "evidence": "independent_factor_mining_20260618"},
    },
...
TSMF_FULL_FACTOR_POOL: list[str] = list(dict.fromkeys([
    # Full factor pool keeps both the stock-selection legs and the supporting
    # risk / regime signals that TSMF evolved around.
    "market_cap",
    "market_cap_rank",
    "is_st",
    "is_paused",
...
TSMF_PREFERRED_FACTOR_POOL_BUCKETS: dict[str, list[str]] = {
    # These buckets are the distilled subset that the later rotation-style
    # experiments actually leaned on.
...
TSMF_STRATEGY_SIGNAL_NOTES: list[dict[str, str]] = [
    {
        ...
        # This describes the rank-buffer exit rule used by the small-cap
        # family, not a standalone factor.
    ...
    },
    {
        ...
        # Re-entry after repair is a state transition, so it sits beside the
        # factor notes rather than inside the factor catalog proper.
...
INDEPENDENT_ASHARE_30_20260618_FACTOR_NAMES: list[str] = [
    "semibeta_downside_avoid_252",
    "semibeta_upside_capture_252",
    "balance_sheet_quality_value_pit",
    "asset_backed_value_proxy_pit",
...
INDEPENDENT_ASHARE_30_20260618_DIRECTIONS: dict[str, str] = {
    "semibeta_downside_avoid_252": "low",
    "semibeta_upside_capture_252": "high",
    "balance_sheet_quality_value_pit": "low",
    "asset_backed_value_proxy_pit": "low",
    ...
    "semibeta_asymmetry_252": "high",
    "paper_defensive_quality_lowvol": "low",
    "jump_intraday_tail_20d": "low",
    "paper_pb_roe_residual": "low",
    "high_volume_signal": "low",
    "paper_high_low_volume_event": "low",
    "paper_new_high_anchor": "high",
    "limit_ecology_quality_combo": "high",
    "low_beta_252": "low",
    "overnight_momentum_20": "high",
    "amihud_low_impact_20": "high",
    "low_max_return_20": "low",
    "low_idio_vol_60": "low",
    "low_downside_vol_60": "low",
    "return_autocorr_20": "low",
...
CATALOG_GROUPS: dict[str, dict[str, Any]] = {
    ...
    "relay_structured_factors": {
        ...
        "description": "Lightweight factors derived from Relay/JQ moneyflow, block moneyflow and auction replay datasets.",
    ...
    "independent_ashare_30_20260618": {
        "name": "independent_ashare_30_20260618",
        "display_name": "Independent A-share 30 Factors 2026-06-18",
        "description": (
            "The 30 logically independent A-share factors from the 2026-06-18 "
            "mining validation note. New daily, PIT financial, limit-ecology "
            "and minute-shape factors are implemented directly in the platform "
            "precompute framework; existing paper/core/Alpha101 ids are reused."
        ),
    ...
    for name, spec in RELAY_FACTOR_SPECS.items():
        definitions.append(_definition(
            ...
            data_policy={
                ...
                "precompute_source": "Local Parquet structured datasets; JQ moneyflow uses trade_date_1",
            },
        ))
